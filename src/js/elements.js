...
export function startTip() {
  ...
  tip.innerText += 'To identify a mushroom, upload an image here!';
...
function resultLinks(latTitle) {
  ...
  wikiLink.href = `https://www.wikipedia.org/wiki/${latTitle}`;
...
function imageDownloadField() {
  ...
  dragAndDropText.innerText = 'Drag an image here';
...
function browseFileButton() {
  ...
  browseFileButton.innerText = 'Select a file';
